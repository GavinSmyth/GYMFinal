...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { address: @user_profile.address, age: @user_profile.age, bio: @user_profile.bio, name: @user_profile.name, ptName: @user_profile.ptName, user_id: @user_profile.user_id } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { address: @user_profile.address, age: @user_profile.age, bio: @user_profile.bio, name: @user_profile.name, ptName: @user_profile.ptName, user_id: @user_profile.user_id } }
