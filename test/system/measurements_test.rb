...
class MeasurementsTest < ApplicationSystemTestCase
  ...
  test "creating a Measurement" do
    ...
    fill_in "Bodyfat", with: @measurement.BodyFat
    fill_in "Week", with: @measurement.week
    fill_in "Weightkg", with: @measurement.weightKG
    fill_in "Weightpounds", with: @measurement.weightPounds
    fill_in "Weightstone", with: @measurement.weightStone
